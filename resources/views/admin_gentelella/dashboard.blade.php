									...
									<div class="x_content">
										...
										<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
											<div class="form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">姓<span class="required">*</span>
												</label>
											...
											<div class="form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">名<span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
											...
											<div class="form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12">生年月日<span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
								...
								<form class="form-horizontal form-label-left" data-parsley-validate>
									...
									<div class="form-group">
										...
										<div class="col-md-9 col-sm-9 col-xs-12">
											<input type="text" class="form-control" required="required" placeholder="Default Input">
										</div>
									</div>
									<div class="form-group">
								...
								<div class="x_content">
									<form class="form-horizontal form-label-left" novalidate>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
												<input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="Miri Kunisada" required="required" type="text">
											</div>
										</div>
										<div class="item form-group">
